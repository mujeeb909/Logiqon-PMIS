...
<head>
    ...
    <title><?php echo e(__('ERP Cloud')); ?></title>
...
<body class="<?php echo e($color); ?>">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        ...
                        <a href="https://hostcyber.net" class="btn btn-outline-light" target="_blank"><i
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            ...
            <img src="<?php echo e(asset('landing/images/dashboard.png')); ?>" alt=""
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="<?php echo e(asset('landing/images/dashboard.png')); ?>" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="<?php echo e(asset('landing/images/dash-2.svg')); ?>" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
            <div class="row align-items-center justify-content-start">
...
<?php /**PATH C:\xampp\htdocs\PMIS\resources\views/layouts/landing.blade.php ENDPATH**/ ?>