...
<?php $__env->startSection('action-btn'); ?>
    ...
    <div class="float-end">
        <a href="#" data-size="md" data-url="<?php echo e(route('form.field.create', $formBuilder->id)); ?>" data-ajax-popup="true"
            data-bs-toggle="tooltip" title="<?php echo e(__('Create New Filed')); ?>" class="btn btn-sm btn-primary">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit form builder')): ?>
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#"
                                                            ...
                                                            data-url="<?php echo e(route('form.field.edit', [$formBuilder->id, $field->id])); ?>"
